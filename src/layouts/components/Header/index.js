                ...
                <div className={cx('actions')}>
                    {isLogin ? (
                        <>
                            ...
                            <TippyDefault delay={[0, 100]} content={'Message'} placement="bottom">
                                <button className={cx('custom-btn')}>
                                    <MessageIcon />
                                </button>
                            </TippyDefault>
                            <TippyDefault delay={[0, 100]} content={'Inbox'} placement="bottom">
                                <button className={cx('custom-btn')}>
                                    <UploadIcon />
                                    <div className={cx('unread')}>12</div>
                                </button>
                            </TippyDefault>
                        </>
                    ) : (
                        <>
                            <Button
                                className={cx('custom-upload-btn')}
                                outline
                    ...
                    <Menu list={isLogin ? userMenu : MENU_ITEM} onChange={handleMenuChange}>
                        {isLogin ? (
                            <Image
                                className={cx('avatar-img')}
                                width="32px"
                                alt="avatar"
                                fallback="https://ssl.gstatic.com/onebox/media/sports/logos/z44l-a0W1v5FmgPnemV6Xw_96x96.png"
